module github.com/Bodo-inc/denali

go 1.22.2

require (
	github.com/apache/iceberg-go v0.0.0-20240529104050-60da61cc0368
...
require (
	...
	github.com/hamba/avro/v2 v2.21.1 // indirect
	...
	github.com/wolfeidau/s3iofs v1.5.2 // indirect
